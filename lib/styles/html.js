 ...
 * - The string methods compose already-formatted fragments and so, as in every
 *   other style, do not escape their input.
 *
 * Urls are always filtered through `filterHyperlinkUrl` and attribute-escaped.
 */
