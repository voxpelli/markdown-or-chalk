...
export function mapObject (obj, callback) {
  // Frozen here rather than at each call site — every consumer of this so far is
  // a shared, module-level lookup that must not be mutable process-wide
  return /** @type {Record<keyof Obj, Value>} */ (Object.freeze(Object.fromEntries(
