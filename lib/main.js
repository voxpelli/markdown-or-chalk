...
/** @import { AlignType, Root, RootContent } from 'mdast' */
/** @import { MdastToChalkOrMarkdownOptions } from './mdast.js' */
/** @import { PhrasingContentOrString, PhrasingContentOrStringList } from './mdast-helpers.js' */
/** @import { LogSymbols } from './symbols.js' */

export const MODE_MARKDOWN = 'markdown';
export const MODE_CHALK = 'chalk';
...
/** @typedef {keyof typeof VALID_MODES} MarkdownOrChalkMode */
...
export class MarkdownOrChalk {
  ...
  /**
   * @returns {ChalkInstance|undefined}
   */
  get chalk () {
  ...
  /**
   * @returns {Record<keyof LogSymbols, PhrasingContentOrString>}
   */
  get logSymbolsMdast () {
